...
<html lang="pt-br">
  <head>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-Jj"></script>
      ...
      <div class="row">
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form method="POST" action="valida-cadastro.php">
            ...
            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" type="submit">Efetuar Pedido</button>
          </form>
        </div>
      </div>
